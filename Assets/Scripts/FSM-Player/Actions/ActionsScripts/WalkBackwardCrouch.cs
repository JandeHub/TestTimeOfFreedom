...
[CreateAssetMenu(menuName = "FSM/Player/Actions/WalkBackwardCrouch")]
public class WalkBackwardCrouch : FSM.Action
{
    public override void Act(Controller controller)
    {
        ...
        controller.SetAnimation("walkCrouchBackward", true);
